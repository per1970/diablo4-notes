---
title: "Guide - Season 14 War Plans Best Nodes"
description: "Optimal War Plans node choices for Diablo 4 Season 14 (Season of Death Awakening). Covers party sync, activity-by-activity rankings for Helltide, Nightmare Dungeons, Undercity, Tree of Whispers, Lair Bosses, Pit, and Infernal Hordes, plus the Corrupted Roots farming loop and passive mythic strategies."
tags:
  - diablo4
  - season14
  - war-plans
...
> Season of Death Awakening · Party Sync added · Overlapping Rift meta · Corrupted Roots farming loop

## What Changed in Season 14

- **Party Sync**: War Plans can now be synchronized across your party. Costs 2 Marks of El'Druin to create a synced plan. Opening War Plans grants 3 Marks by default — you can sync immediately.
- **Maggot farming**: Hellwyrm → Maggot XP engine is the dominant leveling strategy (see Helltide section below).
- **Overlapping Pandemonium Rift meta**: Multiple rifts in close proximity chain off each other via goblin spawns → 10-15 minute farming sessions. Best XP + material combo in the game (Rob2628 hit Paragon 300 in 57h using this).
- **Corrupted Roots self-feeding loop**: New S14 farming strategy combining Tree of Whispers Roots with NMD shrine respawn mechanics (see dedicated section below).
- **No major tree restructure** from S13 — same activity trees, but the meta around which nodes to prioritize has shifted due to new seasonal mechanics, Mythic Unique 3.0, and the Corrupted Roots economy.

Respec any tree anytime with gold. No locking.

## Party Sync Mechanics (New)

1. All party members must be in Temis
2. One player creates a synced War Plan (costs 2 Marks of El'Druin)
3. The party gets a shared board — everyone progresses the same objectives
4. When the party disbands, each player keeps their individual progress plus synced rewards

**Priority:** Sync before any serious group farming session. The 10% party XP bonus + shared cinders + synced War Plans multiply each other.

---

## Corrupted Roots Farming Strategy (New S14 Meta)

A self-feeding farming loop discovered by P4wnyhof that generates massive elite density and Whisper Cache income:
...
### The Loop
1. Complete Whispers → Whisper Caches drop **Corrupted Roots**
2. Plant Roots in a Nightmare Dungeon
3. Activate shrines → Nemesis spawns 7 elites → Gauntlet stores souls → on shrine debuff expiry, souls explode into MORE elites
4. Kill everything → Roots drop more Whisper Caches → more Corrupted Roots
5. Repeat — self-sustaining

**Why this is good in S14:** Elite/champion drop rate for **Echoing Hatred Keys** was increased in S14. More elites = more keys. Echoing Hatred is the new wave-based event in Temis with the best chance at Mythic Seals.

**Grim Retribution** node (Whisper ambushes = collections of keys) feeds the loop further.

---

## Activity-by-Activity Node Rankings

### 1. Helltide (Highest Priority — Leveling + Economy + XP Meta)
...
Unlocks at level 25. Becomes the primary XP source after you unlock Jade Epiphany.
...
### 3. Nightmare Dungeons (Goblin Economy + Material Farm)
...
**Waking Spoils** is a good early one-point wonder — double chest at NMD end.

**Conviction Chest** (bottom) gives Attuned Primordial Dust for unique power rerolls. Less relevant in S14 since crafted Mythics always max out, but still useful pre-Mythic.

### 4. Tree of Whispers (Economy + Corrupted Root Engine)
...
**Priority shift from S13:** Corrupted Roots first now — it enables the Corrupted Roots → NMD shrine farm engine. Resplendent Favor is still the long-term payoff but Roots come first in S14.

**wudijo's take:** Extra Whisper Ambushes (left side) are his first pick — they just give you more stuff passively. XP globes are also good since XP scales into Paragon. Varshan ambush warning: extremely dangerous on Hardcore.

**Simple Gifts vs. Tree of Plenty:** P4wnyhof recommends Simple Gifts (guaranteed materials/keys collection) for more Roots. wudijo prefers the 4th cache choice for flexibility.
...
**Best Path: Middle for speed, left for talismans**
...
## Endgame Priority Order (70+, Torment+)
