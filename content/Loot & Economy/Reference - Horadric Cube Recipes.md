...
> **Requires:** Lord of Hatred expansion (LoH). Not available to base game players.
> **Location:** Temis, the hub city in Skovos Isles. Unlocked by completing the LoH campaign. Account-wide once unlocked — alts that skip the campaign can still access it.
...
Handled at **The Jeweler** (Rune crafting interface), not the Cube directly — but uses Cube-farmed Runes as materials.

**Cost:** 6 Specific Magic Runes + 6 Specific Rare Runes + 6 Specific Legendary Runes + 1 Resplendent Spark

- Completely eliminates RNG — crafts the exact Mythic Unique you want.
- Resplendent Sparks are primarily obtained from Season Rank rewards and by disenchanting excess Mythic Uniques.
- Use Cube Amalgamation to upgrade Rune tiers toward the required Legendary Runes.

---

## Secret Recipes
Blizzard has confirmed **undocumented recipes** exist — ingredients found in unusual locations in the world, inspired by D2's hidden recipe tradition. The community is still mapping these.

> ⚠️ Do not spend rare materials experimenting until the community has confirmed outcomes. Wait for signal, not noise, especially in the first weeks of a season.
